...
public void cargar_datos(String provincia){
    ...
    Vendedor v1=new Vendedor(1,"JFJ","Vende_todo",provincia,"elche","calle");
    ...
    Vendedor v4=new Vendedor(4,"Paco","El_rapido",provincia,"Sant","Jua");
    Vendedor v5=new Vendedor(5,"luis","Come_bolas","Valencia","Sant","Jua");
    vende.add(v1);
    vende.add(v2);
    vende.add(v3);
    vende.add(v4);
